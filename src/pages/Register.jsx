          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className={`auth-field ${focused==="username"?"auth-field--focus":""}`}>
              ...
              <div className="auth-input-wrap">
                ...
                <input type="text" name="username" placeholder="digvijay"
                ...
                {form.username.length >= 3 && (
                  <span className="auth-field-ok">
                    <svg viewBox="0 0 16 16" fill="currentColor" width="12"><path d="M13.78 4.22a.75.75 0 010 1.06l-7.25 7.25a.75.75 0 01-1.06 0L2.22 9.28a.75.75 0 011.06-1.06L6 10.94l6.72-6.72a.75.75 0 011.06 0z"/></svg>
                  </span>
                )}
              </div>
            </div>
            ...
            <div className={`auth-field ${focused==="password"?"auth-field--focus":""}`}>
              ...
              <div className="auth-input-wrap">
                ...
                <input type={showPw?"text":"password"} name="password" placeholder="Min 8 characters"
            ...
            <button type="submit" className="auth-submit auth-submit--green" disabled={loading || warming}>
              {loading || warming
                ? <><span className="auth-btn-spinner"/> {warming?"Connecting…":"Creating account…"}</>
